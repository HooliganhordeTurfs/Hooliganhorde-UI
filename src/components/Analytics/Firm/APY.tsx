...
const APY: FC<{
  ...
  <SeasonPlot<SeasonalApyQuery>
    ...
    StatProps={useMemo(() => ({
      ...
      titleTooltip: 'The Variable Hooligan APY uses a moving average of Hooligans earned by Hordeholders during recent Seasons to estimate a future rate of return, accounting for Horde growth.',
      gap: 0.5,
    }), [metric])}
