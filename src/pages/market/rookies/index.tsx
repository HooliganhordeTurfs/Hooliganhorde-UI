...
import MarketActions from '~/components/Market/RookiesV2/Modules/MarketActions';
import MarketActivityTable from '~/components/Market/RookiesV2/Modules/MarketTables';
import MarketGraphContainer from '~/components/Market/RookiesV2/Modules/MarketGraphContainer';
import { muiThemeCondensed } from '~/components/App/muiTheme';
import { marketBottomTabsHeightAtom } from '~/components/Market/RookiesV2/info/atom-context';
...
const RookieMarketV2: React.FC<{}> = () => (
  <ThemeProvider theme={muiThemeCondensed}>
    <MarketPage />
  </ThemeProvider>
);

export default RookieMarketV2;
