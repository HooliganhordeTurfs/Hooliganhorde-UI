...
const sliderSx = (canSlide?: boolean) => ({
  ...
  '& .MuiSlider-track': {
    height: '8px',
    color: canSlide ? 'primary.main' : HooliganhordePalette.lightYellow,
  },
  '& .MuiSlider-rail': {
    color: HooliganhordePalette.lightYellow,
    opacity: 1,
    height: '8px',
    borderRadius: '2px',
  },
...
const PlaceInLineSlider: React.FC<{
  ...
  const fieldMaxIndex = hooliganhordeField?.rookieLine || ZERO_BN;
