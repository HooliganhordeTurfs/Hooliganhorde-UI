          ...
          <Group>
            ...
            {tooltip ? (
              <div>
                ...
                >
                  <Card sx={{ p: 1, backgroundColor: HooliganhordePalette.lightestBlue, border: '1px solid', borderColor: 'divider' }}>
                        ...
                        {reversedKeys.map((key, index) => (
                          <Row key={index} justifyContent="space-between" gap={3}>
                            <Row gap={1}>
                              ...
                              />
                              <Typography>{firmTokens[key]?.symbol}</Typography>
                            </Row>
...
// For reference on how to use this chart, refer to HooliganVs3Crv.tsx
