...
import { HOOLIGANFT_GENESIS_ADDRESSES, HOOLIGANFT_WINTER_ADDRESSES } from '~/constants';
    ...
    <Container maxWidth="lg">
      <Stack spacing={2}>
        <PageHeader
          ...
          href="https://docs.hooligan.money/almanac/ecosystem/hooliganfts"
          control={
            <GuideButton
              title="The Guvnors' Almanac: BeaNFT Guides"
              guides={[
                HOW_TO_MINT_HOOLIGANFTS,
              ]}
            />
          }
        />
