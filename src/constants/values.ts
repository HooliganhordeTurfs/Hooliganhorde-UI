...
/* Weather */
export const ROOKIE_RATE_LOWER_BOUND = 5; /* 5% */
export const OPTIMAL_ROOKIE_RATE = 15; /* 15% */
export const ROOKIE_RATE_UPPER_BOUND = 25; /* 25% */

export const STEADY_SOW_TIME = 60; /* 1 minute */

export const DELTA_ROOKIE_DEMAND_LOWER_BOUND = 0.95; /* 95% */
export const DELTA_ROOKIE_DEMAND_UPPER_BOUND = 1.05; /* 105% */
...
export const CONVERT_HOOLIGAN_SLIPPAGE = 0.980; /* 2.0% slippage */
