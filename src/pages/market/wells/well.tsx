...
import hordeIcon from '~/img/hooliganhorde/horde-icon.svg';
    ...
    <Stack gap={2}>
      <PagePath
        items={[
          ...
          {
            title: 'HOOLIGAN:ETH Liquidity Well',
            path: '/'
          }
        ]}
      />
      <PageHeader
        title={
          <Row gap={1}>
            <Row gap={0.2}>
              <img alt="" src={hooliganIcon} height={IconSize.medium} />
              <img alt="" src={ethIcon} height={IconSize.medium} />
            </Row>
            <Typography variant="h2" textAlign="center" sx={{ verticalAlign: 'middle' }}>HOOLIGAN:ETH Liquidity
              Well
            </Typography>
          </Row>
        }
        ...
        <Grid container>
          ...
          <Grid item xs={6} md={1.5}>
            <WellStat
              ...
              subTitle={
                <Row>
                  <img src={hordeIcon} alt="" height={IconSize.small} />
                  <Typography variant="h4">
          ...
          <Grid item xs={6} md={2.75}>
            <WellStat
              title="Hooligans Earned by Depositors (7D)"
              subTitle={
                <Typography variant="h4">
                  Constant Product
                </Typography>
          ...
          <Grid item xs={6} md={2.75}>
            <WellStat
              title="Horde Grown by Depositors (7D)"
              subTitle={
                <Typography variant="h4">
                  Constant Product
                </Typography>
