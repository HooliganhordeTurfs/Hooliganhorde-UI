        ...
        >
          <Stack width="100%" gap={0.5}>
            <Row justifyContent="space-between">
              <Typography variant="body1">price per rookie</Typography>
              <Typography variant="body1">
                {displayBN(selectedOrder.pricePerRookie)}
              </Typography>
            </Row>
            <Row justifyContent="space-between">
            ...
            <Row justifyContent="space-between">
              ...
              <Typography variant="body1">
                {displayBN(selectedOrder.rookieAmountRemaining)}
              </Typography>
            </Row>
          </Stack>
        </Button>
              ...
              >
                <Stack width="100%" gap={0.5}>
                  <Row justifyContent="space-between">
                    <Typography variant="body1">price per rookie</Typography>
                    <Typography variant="body1">
                      {displayBN(order.pricePerRookie)}
                    </Typography>
                  </Row>
                  <Row justifyContent="space-between">
                    <Typography variant="body1">max place in line</Typography>
                  ...
                  <Row justifyContent="space-between">
                    <Typography variant="body1">amount</Typography>
                    <Typography variant="body1">
                      {displayBN(order.rookieAmountRemaining)}
                    </Typography>
                  </Row>
                </Stack>
              </Button>
