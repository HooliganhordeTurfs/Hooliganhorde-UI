...
export type TokenInputCustomProps = {
   ...
   *
   */
  balance?: GuvnorBalances[string] | BigNumber | undefined;
  /**
   *
   */
  balanceLabel?: string;
  ...
  const [balance, balanceTooltip] = useMemo(() => {
    ...
    return [_balance.total, (
      <>
        ...
        The Hooliganhorde UI first spends the balance that is most gas-efficient based on the specified amount.
      </>
    )];
  }, [_balance, token]);
