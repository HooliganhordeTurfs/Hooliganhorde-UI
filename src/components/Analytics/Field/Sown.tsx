...
const getValue = (season: SnapshotData<SeasonalSownQuery>) => toTokenUnitsBN(season.sownHooligans, HOOLIGAN[1].decimals).toNumber();
const formatValue = (value: number) => `${value.toLocaleString('en-US', { maximumFractionDigits: 0 })}`;
const statProps = {
  title: 'Hooligans Sown',
  titleTooltip: 'The total number of Hooligans Sown at the end of each Season.',
  gap: 0.25,
  sx: { ml: 0 }
};
