...
import rookieIcon from '~/img/hooliganhorde/pod-icon.svg';
          ...
          <Row justifyContent="space-between" sx={{ width: '100%' }}>
            <Row justifyContent="center">
              ...
              <ListItemText
                ...
                secondary={(
                  <>
                    {isMobile ? '@' : 'Place in Line:'} {displayBN(new BigNumber(index).minus(draftableIndex))}{listing ? <>&nbsp;&middot; Currently listed</> : null}
                  </>
                )}
                sx={{ my: 0 }}
              />
            ...
            {plots[index] ? (
              <Typography variant="bodyLarge">
                {displayFullBN(plots[index], ROOKIES.displayDecimals)}
              </Typography>
              ) : null}
          </Row>
        </ListItemButton>
