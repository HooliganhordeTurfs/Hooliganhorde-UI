...
const BUTTON_SX = {
  ...
  '&.Mui-active': {
    color: 'white',
    backgroundColor: HooliganhordePalette.theme.winter.primary,
    // ':hover': {
    //   backgroundColor: HooliganhordePalette.theme.winter.primaryDark
    // }
  },
  borderRadius: '4px',
};
...
const SubActionSelect: FC<{
  ...
  <Row gap={0.8}>
    ...
    <Tooltip title={id ? '' : `Select a Rookie ${action === 'buy' ? 'Listing' : 'Order'} on the graph to Fill.`}>
      <div>
        <Button 
          variant="text"
          component={NavLink}
...
//   </Tooltip>
//   {/* <SubAction
//        isActive={orderType !== RookieOrderType.FILL}
//        onClick={() =>
//         setOrderType(
//           orderAction === RookieOrderAction.BUY
//             ? RookieOrderType.ORDER
//             : RookieOrderType.LIST
//         )
//       }
//     >
//        <Typography variant="caption">
//          {orderAction === RookieOrderAction.BUY ? 'ORDER' : 'LIST'}
//        </Typography>
//      </SubAction>
//      <SubAction
//        isActive={orderType === RookieOrderType.FILL}
//        onClick={() => setOrderType(RookieOrderType.FILL)}
//     >
