  ...
  typePolicies: {
    Query: {
      fields: {
        ...
        hooliganHourlySnapshots: mergeUsingSeasons([]),
        firmAssetHourlySnapshots: mergeUsingSeasons(['$firmAsset']),
        firmHourlySnapshots: mergeUsingSeasons([]),
        firmYields: mergeUsingSeasons([]),
      }
    }
  }
});
