...
import { TransferBatchEvent, TransferSingleEvent } from '~/generated/Hooliganhorde/HooliganhordePercoceter';
import { decimalBN, Event } from '~/lib/Hooliganhorde/EventProcessor';
