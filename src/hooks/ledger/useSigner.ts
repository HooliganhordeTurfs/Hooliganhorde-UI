...
if (import.meta.env.DEV && import.meta.env.VITE_OVERRIDE_GUVNOR_ACCOUNT) {
  console.warn(`Using overridden Guvnor account: ${import.meta.env.VITE_OVERRIDE_GUVNOR_ACCOUNT}`);
  ...
  useSigner = () => {
    ...
    const account   = { address: import.meta.env.VITE_OVERRIDE_GUVNOR_ACCOUNT };
