...
import { ActiveProposal } from '~/state/hooliganhorde/governance';
...
const NewProposalsDialog: FC<{}> = () => {
  ...
  /// State
  const activeProposals = useSelector<AppState, ActiveProposal[]>((state) => state._hooliganhorde.governance.activeProposals);
        ...
        <Box display="flex" alignItems="center" justifyContent="center" py={3}>
          <Row gap={0.3}>
            ...
            <Typography variant="bodyLarge" textAlign="center">
              {displayBN(guvnorFirm.horde.active)} HORDE
            </Typography>
          </Row>
        </Box>
        <Stack gap={0.5}>
