...
> = ({
  ...
  if (baseMode === FarmToMode) {
    ...
    farmDesc = _farmDesc || 'Send assets to your internal balance within Hooliganhorde.';
    label    = _label    || 'Destination';
  } else {
    circDesc = _circDesc || 'Use assets from your wallet.';
    farmDesc = _farmDesc || 'Use assets to your internal balance within Hooliganhorde.';
    label    = _label    || 'Source';
  }
