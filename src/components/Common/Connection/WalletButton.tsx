...
import gearIcon from '~/img/hooliganhorde/interface/nav/gear.svg';
import historyIcon from '~/img/hooliganhorde/interface/nav/history.svg';
import etherscanIcon from '~/img/hooliganhorde/interface/nav/etherscan.svg';
import disconnectIcon from '~/img/hooliganhorde/interface/nav/disconnect.svg';
...
import PickHooligansDialog from '~/components/Guvnor/Unripe/PickDialog';
...
const WalletButton: FC<{ showFullText?: boolean; } & ButtonProps> = ({ ...props }) => {
  ...
  const menu = (
    <MenuList sx={{ minWidth: 250, background: HooliganhordePalette.white, border: '1px solid', borderColor: 'divider' }} component={Card}>
      <MenuItem onClick={() => {
        toggleMenuAnchor();
      ...
      <Box sx={{ px: 1, pb: 0.25 }}>
        <Button
          ...
          sx={{
            py: 1.25,
            color: HooliganhordePalette.brown,
            backgroundColor: HooliganhordePalette.lightBrown,
            '&:hover': {
              backgroundColor: HooliganhordePalette.lightBrown,
              opacity: 0.96
            },
      ...
      <Box sx={{ px: 1, pt: 0.75, pb: 0.25 }}>
        <Button
          ...
          href="/#/chop"
          sx={{ 
            background: HooliganhordePalette.brown,
            py: 1.25,
            '&:hover': {
              background: HooliganhordePalette.darkBrown,
              opacity: 0.96
            }
          }}
        >
  ...
  return (
    <>
      ...
      <Button
        ...
        sx={import.meta.env.VITE_OVERRIDE_GUVNOR_ACCOUNT ? {
          color: 'text.primary',
