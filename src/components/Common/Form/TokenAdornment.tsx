...
import { HooliganhordePalette, hexToRgba, IconSize } from '../../App/muiTheme';
          ...
          {onClick && (
            <KeyboardArrowDownIcon
              sx={{
                ...
                color: hexToRgba(HooliganhordePalette.textBlue, 0.87)
                // color: hexToRgba(HooliganhordePalette.theme.winter.primary, 0.87)
              }}
            />
          )}
        </Row>
