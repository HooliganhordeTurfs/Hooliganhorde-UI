...
export const HOOLIGANFT_GENESIS_ADDRESSES = {
  [SupportedChainId.MAINNET]: '0xa755A670Aaf1FeCeF2bea56115E65e03F7722A79'.toLowerCase(),
};

export const HOOLIGANFT_WINTER_ADDRESSES = {
  [SupportedChainId.MAINNET]: '0x459895483556daD32526eFa461F75E33E458d9E9'.toLowerCase(),
};

// ----------------------------------------
// Hooligan & Unripe Hooligan Tokens
// ----------------------------------------

export const HOOLIGAN_ADDRESSES = {
  [SupportedChainId.MAINNET]: '0xBEA0000029AD1c77D3d5D23Ba2D8893dB9d1Efab'.toLowerCase(),
};

export const UNRIPE_HOOLIGAN_ADDRESSES = {
  // --------------------------------------------------
  // "Unripe Hooligan": Unripe vesting asset for the Hooligan token, Localhost
  // -------------------------------------------------
  [SupportedChainId.MAINNET]: '0x1BEA0050E63e05FBb5D8BA2f10cf5800B6224449'.toLowerCase(),
};

export const UNRIPE_HOOLIGAN_CRV3_ADDRESSES = {
  // --------------------------------------------------
  // "Unripe HOOLIGAN:CRV3 LP": Unripe vesting asset for the HOOLIGAN:CRV3 LP token, Localhost
  // -------------------------------------------------
...
// ----------------------------------------
// Curve Pools: HOOLIGAN
// ----------------------------------------

export const HOOLIGAN_CRV3_ADDRESSES = {
  // --------------------------------------------------
  // "Curve.fi Factory USD Metapool: Hooligan (HOOLIGAN3CRV-f)"
  // [Implements: ERC20 & Metapool]
  // --------------------------------------------------
  // coins[0] = 0xBEA0003eA948Db32082Fc6F4EC0729D258a0444c (HOOLIGAN)
  // coins[1] = 0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490 (3CRV)
  //
  // 1. Creates a HOOLIGAN:3CRV Metapool contract.
  // 2. Issues HOOLIGAN3CRV-f, the pool's LP token. The pool address and
