...
import MockPlot from '~/components/Firm/MockPlot';
import { PROSPECTS, HORDE } from '~/constants/tokens';
import { SeasonAggregation, SeasonRange, SEASON_RANGE_TO_COUNT } from '~/hooks/hooliganhorde/useSeasonsQuery';
              ...
              <Stack justifyContent="center" alignItems="center" height="100%" gap={1}>
                {!account ? (
                  ...
                  <Typography variant="body1" color="text.tertiary">
                    Receive <TokenIcon token={HORDE} />Horde and <TokenIcon token={PROSPECTS} />Prospects for Depositing whitelisted assets in the Firm. Hordeholders earn a portion of new Hooligan mints. Prospects grow into Horde every Season.
                  </Typography>
                ) : null}
              </Stack>
            </BlurComponent>
