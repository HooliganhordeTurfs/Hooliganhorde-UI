...
export default abstract class Pool {
   ...
   *
   * @param amount - the amount of LP tokens the guvnor owns
   * @param reserve - the reserve of an asset in the lp pool
   * @param totalLP - the total lp tokens
   * @returns the amount of reserve tokens the guvnor owns.
   */
  static tokenForLP = (
    amount: BigNumber,
    reserve: BigNumber,
  ...
  /**
   * Used to calcuate the # of reserve tokens owned by a guvnor for 2 assets in a pool (e.g. Hooligans + Eth)
  ...
  /**
   * The opposite of tokenForLP. If a guvnor owns/deposits X of reserve asset -> how many LP tokens do they 1 own/get.
   *
   * @param amount - the amount of the reserve asset the guvnor has
  ...
  /**
   * The opposite of poolForLP - used to calculate how many LP tokens a guvnor gets if they deposit both reserve assets in a 2 asset pool.
   * e.g. if a guvnor deposits amount1 of Hooligans and amount2 of Eth into an LP pool with reserve1 Hooligans, reserve2 Eth and totalLP LP tokens, it returns how many LP tokens the farmer gets.
   */
  static lpForPool = (
    amount1: BigNumber,
    reserve1: BigNumber,
