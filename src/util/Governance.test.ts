...
describe('parsing', () => {
  const tag1 = getProposalTag('BSP-7: Fund Hooligan Portion of the Six-Month Halborn Retainer');
  const tag2 = getProposalTag('BFCP-A-4: Add sweetredhooligans to the BFC');
