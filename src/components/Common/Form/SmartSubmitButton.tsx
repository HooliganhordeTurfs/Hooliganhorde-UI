...
import useAllowances from '~/hooks/guvnor/useAllowances';
import useChainConstant from '~/hooks/chain/useChainConstant';
import { useGetERC20Contract } from '~/hooks/ledger/useContract';
import Token from '~/classes/Token';
import { parseError, trimAddress } from '~/util';
import { HOOLIGANHORDE_ADDRESSES, HOOLIGANHORDE_PERCOCETER_ADDRESSES } from '~/constants/addresses';
...
const CONTRACT_NAMES : { [address: string] : string } = {
  [HOOLIGANHORDE_ADDRESSES[SupportedChainId.MAINNET]]: 'Hooliganhorde',
  [HOOLIGANHORDE_PERCOCETER_ADDRESSES[SupportedChainId.MAINNET]]: 'Hooliganhorde Percoceter',
};
