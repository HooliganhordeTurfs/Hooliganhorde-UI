...
export enum SupportedChainId {
  MAINNET = 1,
  CUJO = 31337,     // pre-exploit, hooliganhorde replanted
  LOCALHOST = 1337,
}

/**
 * These chains use Hooliganhorde Replanted, which has different
 * function signatures than the Hooliganhorde V1.
 */
