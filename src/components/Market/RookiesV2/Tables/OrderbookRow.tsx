...
import { PriceBucket } from '~/hooks/hooliganhorde/useOrderbook';
...
const OrderBookRow: React.FC<{
  ...
  >
    ...
    <Grid item container xs={5.25}>
      <Grid item xs={6}>
        <Typography variant="caption" sx={{ color: HooliganhordePalette.theme.winter.orderGreen }}>
          {displayBN(bucket.depth.hooligan || ZERO_BN)}
        </Typography>
      </Grid>
    ...
    <Grid item container xs={5.25}>
      <Grid item xs={6}>
        <Typography variant="caption" sx={{ color: HooliganhordePalette.theme.winter.listingRed }}>
          {displayBN(
      ...
      <Grid item xs={6} alignItems="flex-end" textAlign="right">
        <Typography variant="caption" sx={{ color: HooliganhordePalette.theme.winter.listingRed }}>
          {displayBN(bucket.depth.rookies)}
        </Typography>
      </Grid>
    </Grid>
  </Grid>
