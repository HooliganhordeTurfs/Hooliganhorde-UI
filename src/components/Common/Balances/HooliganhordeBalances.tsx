...
import useHooliganhordeFirmBreakdown, { StateID, STATE_CONFIG } from '~/hooks/hooliganhorde/useHooliganhordeBalancesBreakdown';
...
const HooliganhordeBalances: FC<{
  breakdown: ReturnType<typeof useHooliganhordeFirmBreakdown>;
}> = ({
  breakdown,
}) => {
  // Constants
...
export default HooliganhordeBalances;
