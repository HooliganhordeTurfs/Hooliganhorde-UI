...
const useCardContentWithToken = (token: ERC20Token) => [
  {
    ...
    texts: [
      ...
      } from your wallet or Farm balance to Deposit ${token.symbol} into the Firm.${
  ...
  },
  {
    ...
    texts: [
      ...
      'Prospects yield 1/10000 new Horde every Season.',
    ],
  ...
  },
  {
    ...
    texts: [
      'Every Season that Hooligans are minted, receive a share of the new Hooligans based on your percentage ownership of Horde.',
      'You can claim your Firm Rewards on the main Firm page.',
    ],
    imageSrc: earnHooligansImg, // Made this one a PNG because it contains 4 BeaNFTs which are too big when base64 encoded in an SVG.
  },
];
